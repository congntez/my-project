...
<div class="center">
	<a href="#">
		<img src="<?php echo site_url('public/assets/images/homepage/logo2.png')?>" class="a_admin_logo" alt="">
	</a>
</div>
			...
			<li>
				...
				?>"
				   ...
				   title="<?php echo $item["text"] ?>">
					<i class="fa <?php echo $item["icon"] ?> left" data-position="right" data-delay="40"
					   data-tooltip="<?php echo $item["text"] ?>"></i>
					<?php if (!$is_child) { ?>
