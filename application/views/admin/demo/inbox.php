                                            ...
                                            <div class="message-toolbar hide">
                                                <div class="inline position-relative align-left">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-lighter dropdown-caret dropdown-125">
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <i class="ace-icon fa fa-folder-open orange"></i>&nbsp;
                                                                Archive
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <i class="ace-icon fa fa-eye blue"></i>&nbsp; Mark as
                                                                read
                                                            </a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <i class="ace-icon fa fa-eye-slash green"></i>&nbsp;
                                                                Mark unread
                                                            </a>
                                                        </li>
                                    ...
                                    <div class="message-list-container">
                                        ...
                                        <div class="message-list" id="message-list">
                                            ...
                                            <div class="message-item message-unread">
                                                ...
                                                <span class="sender"
                                                      title="Alex John Red Smith">Alex John Red Smith </span>
                                            ...
                                            <div class="message-item">
                                                ...
                                                <span class="time">Yesterday</span>
                                                                    ...
                                                                    <span class="summary">
                                                                        <span
                                                                            class="badge badge-success mail-tag"></span>
                                                                        <span class="text">
            ...
            <div class="hide message-content" id="id-message-content">
                ...
                <div class="message-header clearfix">
                    <div class="pull-left">
                        ...
                        &nbsp;
                        <img class="middle" alt="John's Avatar" src="../public/assets/avatars/avatar.png" width="32"/>
                        &nbsp;
                ...
                <div class="message-attachment clearfix">
                    ...
                    <div class="attachment-images pull-right">
                        ...
                        <div>
                            <img width="36" alt="image 4" src="../public/assets/images/gallery/thumb-4.jpg"/>
                            <img width="36" alt="image 3" src="../public/assets/images/gallery/thumb-3.jpg"/>
                            <img width="36" alt="image 2" src="../public/assets/images/gallery/thumb-2.jpg"/>
                            <img width="36" alt="image 1" src="../public/assets/images/gallery/thumb-1.jpg"/>
                        </div>
                    </div>
                </div>
